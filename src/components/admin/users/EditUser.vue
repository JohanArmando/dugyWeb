<template>
    <div class="panel panel-default">
      <div class="panel-heading panel-heading-doggy">
        <div class="title">Usuario {{ user.name }}</div>
      </div>
        ...
        <div class="col-md-8 backgroundColorGrey">
          <form @submit.prevent="putUser">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="exampleSelectID">Roll del usuario</label>
                  <select :value="user.role.id" v-on:input="updateValue('role',$event)" class="form-control" name="" required>
