  ...
  <nav class="navbar navbar-default navbar-defa">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="javascript:void(0);" class="left-toggle-left-sidebar js-left-toggle-left-sidebar" v-on:click="toggleSideBar()">
        ...
        <div class="collapse navbar-collapse walker" id="navbar-collapse">
          ...
          <ul class="nav navbar-nav">
              <li>
                  <a href="javascript:void(0);" class="toggle-left-sidebar js-toggle-left-sidebar" v-on:click="toggleSideBar()">
                      <i class="fa fa-navicon whiteColor"></i>
                  </a>
              </li>
          </ul>
                ...
                <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="body">
                            <ul>
                                <li>
                                    <router-link :to="'/client/profile/'+user.id">
